...
public class ReaderService1(ILogger<ReaderService1> logger) : BackgroundService
{
    protected override async Task ExecuteAsync(CancellationToken stoppingToken)
    {
        ...
        logger.LogInformation("Starting to read (Reader 1)..");
        ...
        while (!stoppingToken.IsCancellationRequested)
        {
            ...
            if (result.Length == 1)
            {
                logger.LogDebug("Reader 1 read message {messageId}, value: {streamFieldValue}",
